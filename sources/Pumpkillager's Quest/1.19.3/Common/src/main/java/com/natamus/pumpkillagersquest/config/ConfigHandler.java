...
public class ConfigHandler extends DuskConfig {
	...
	@Entry public static double pumpkillagerSpawnChance = 0.1;
	@Entry public static boolean enablePumpkillagerSpawnDuringCreative = false;
	@Entry public static double finalBossMaxHealth = 300.0;
	@Entry public static int experienceAmountRewardFinalBoss = 250;
	@Entry public static double chanceForPumpkinBlockToSpawnOnPigSpawn = 0.05;
