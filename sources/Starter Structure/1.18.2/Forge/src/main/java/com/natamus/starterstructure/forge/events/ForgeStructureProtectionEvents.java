...
public class ForgeStructureProtectionEvents {
	...
	public void onTNTExplode(ExplosionEvent.Detonate e) {
		StructureProtectionEvents.onTNTExplode(e.getWorld(), null, e.getExplosion());
	}

	@SubscribeEvent
	public void onLivingAttack(LivingAttackEvent e) {
		LivingEntity livingEntity = e.getEntityLiving();
		if (!StructureProtectionEvents.onLivingAttack(livingEntity.getLevel(), livingEntity, e.getSource(), e.getAmount())) {
			e.setCanceled(true);
		}
	}
}
