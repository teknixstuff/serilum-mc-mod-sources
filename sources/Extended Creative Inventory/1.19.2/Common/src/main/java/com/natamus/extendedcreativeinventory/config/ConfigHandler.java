...
public class ConfigHandler extends DuskConfig {
	...
	@Entry(min = -1, max = 100) public static int extendedItemGroupIndex = 4;

	public static void initConfig() {
		configMetaData.put("extendedItemGroupIndex", Arrays.asList(
			"The index of the 'Extended' creative tab. Can be changed if another mod already uses the default fifth spot (index 4). A value of -1 will automatically place the tab."
		));
